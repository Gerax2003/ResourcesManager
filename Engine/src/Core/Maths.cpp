...
bool Maths::intersectSegmentBox(const Vector3& p1, const Vector3& p2, const Box& box, Vector3& intersectPt, Vector3& intersectNormal)
{
	...
	Quaternion quadRotation = QuaternionMultiply(quaternion, QuaternionFromAxisAngle({ 0.0f, 0.0f, 1.0f }, PI / 2.0f));
	...
	quad.rotation = QuaternionToEulerRadians(QuaternionMultiply(quaternion, QuaternionFromAxisAngle({ 0.0f, 1.0f, 0.0f }, PI)));
	...
	quad.rotation = QuaternionToEulerRadians(QuaternionMultiply(quaternion, QuaternionFromAxisAngle({ 1.0f, 0.0f, 0.0f }, PI / 2.0f)));
